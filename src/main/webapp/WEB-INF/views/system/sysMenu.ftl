...
<@layout>
    <script>
        ...
        function openRoles(){
            ...
            if (row!=null) {
                popup.openIframe('菜单相关角色','${ctx!}/sysMenu/roles?id=' + row.id, '600px', '500px');
            } else {
        ...
        function openButtons(){
            ...
            if (row!=null) {
                ...
                popup.openIframe('配置按钮','${ctx!}/sysMenu/buttons?id=' + row.id, '450px', '400px');
            } else {
    ...
    <div id="tb">
        ...
        <a onclick="openButtons()" href="javascript:void(0)" class="easyui-linkbutton " iconCls="iconfont icon-config" plain="true"> 配置按钮</a>
    </div>
...
<script>
    ;(function () {
      ...
      /*          {field: 'icon', title: '图标', width: 250},*/
                ...
                {field: 'btnCount', align:'center', title: '按钮数量', width: 100,
                    formatter:
                        function(val){
