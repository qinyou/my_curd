...
<@layout>
    <form id="modelForm" method="POST" action="${ctx!}/genOnline/genModelDict" >
        <table class=" pure-table pure-table-horizontal fullWidthTable labelInputTable">
            ...
            <tr>
                ...
                <td>
                <span >
                    <input class="easyui-radiobutton" name="singleFile" labelPosition="after"  <#if singleFile> checked='true' </#if> value="YES"  label="单">
                </span>
                    <span >
                    <input class="easyui-radiobutton" name="singleFile" labelPosition="after"  <#if !singleFile> checked='true' </#if> value="NO" label="多">
                </span>
                </td>
            </tr>
