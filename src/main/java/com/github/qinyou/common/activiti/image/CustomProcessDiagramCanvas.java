...
public class CustomProcessDiagramCanvas {
    ...
    // Fonts
    protected static Font LABEL_FONT = new Font(ActConst.DEFAULT_FONT, Font.ITALIC, 11);
    protected static Font ANNOTATION_FONT = new Font(ActConst.DEFAULT_FONT, Font.PLAIN, FONT_SIZE);
    protected static Font TASK_FONT = new Font(ActConst.DEFAULT_FONT, Font.PLAIN, FONT_SIZE);
