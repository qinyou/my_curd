...
public class GeneratorConfig {
    ...
    public static String schemaPattern = "my_curd_oa";   // 数据库 schema
    public static String ignoreTablePrefixes = "act_"; // 忽略的表 前缀，多个之间 逗号分隔
    ...
    // 数据源名, 根据实际情况配置
    public static String dsName = "my_curd_oa"; // main 或 my_curd_oa
